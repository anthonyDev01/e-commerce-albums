...
export default {
    ...
    theme: {
        extend: {
            ...
            backgroundImage: {
                "background-home":
                    "linear-gradient(0deg, rgba(0, 0, 0, 0.50) 0%, rgba(0, 0, 0, 0.50) 100%), url(/assets/bg-1.jpg)",
                "background-dashboard":
                    "linear-gradient(180deg, rgba(25,24,31,0) 0%, rgba(25,24,31,1) 97%), url(/assets/banner-bg.jpg)",
                "background-title":
