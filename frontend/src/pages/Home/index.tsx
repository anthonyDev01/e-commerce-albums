...
const Home = () => {
    return (
        <>
            <NavBar />
            <main className="w-screen h-screen bg-[url('./assets/bg-1.jpg')] bg-cover bg-center flex justify-center items-center gap-6 text-white s640:justify-normal">
                <div className="flex justify-center gap-[24px] flex-col w-11/12 s640:w-[400px] s640:ml-[50px] s740:w-[600px] s940:ml-[100px] s940:w-[701px]">
                    <MainTitle fontSize="text-2xl s440:text-3xl s740:text-4xl s940:text-[64px] s940:leading-none" />
